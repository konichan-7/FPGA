...
set rc [catch {
  ...
  elaborate -top {responder}
  export_db {responder_elaborate.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  read_adc ../../responder.adc
  optimize_rtl
  report_area -file responder_rtl.area
  export_db {responder_rtl.db}
} RESULT]
if {$rc} {
  step_error opt_rtl
  return -code error $RESULT
...
set rc [catch {
  optimize_gate -maparea responder_gate.area
  legalize_phy_inst
  export_db {responder_gate.db}
} RESULT]
if {$rc} {
  step_error opt_gate
  return -code error $RESULT
